                    ...
                    <div className="row align-items-center mt-40 animate__animated">
                        <div className="col-lg-6 col-md-6">
                            <div className="service-disctription">
                                <span><Link href="/service-details/1">Plant & Refractory</Link> Services Built Specifically For Mining & Industry</span>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <div className="eulding-btn service">
                                <Link href="#" onClick={handleSmoothScroll}>View All Services</Link>
                            </div>
                        </div>
                    </div>
                </div>
