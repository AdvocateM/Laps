                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-wiget animate__animated animate__zoomIn" >
                                ...
                                <p>Laps Projects and Logistics is a registered company providing professional key services to the mining and industrial sectors. From plant maintenance and refractory repairs to fuel system management and civil construction, we deliver safe, reliable, and cost-effective solutions for clients across South Africa.</p>
                                </div>
                    ...
                    <div className="row mt-110">
                        <div className="col-lg-6 col-md-12">
                            <div className="copyright-text">
                                <p>Copyright &copy; <Link href="https://morubetsi.co.za" target='_blank'>Morubetsi Projects (Pty) Ltd</Link> All Rights Reserved.</p>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12">
