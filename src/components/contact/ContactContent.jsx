                    ...
                    <div className="row mb-150">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="contact-single-box">
                                ...
                                <div className="contact-content">
                                    <h4>E-mail</h4>
                                    <span><a href="mailto:inquiry@example.com<">malapanemaven@gmail.com</a></span>
                                    <span><a href="mailto:info@example.com" >info@lapsprojectsandlogistics.co.za</a></span>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="contact-single-box two">
                                ...
                                <div className="contact-content">
                                    <h4>Address</h4>
                                    <span>Office No 3.7, Block 7, Steelpoort, 1133</span>
                                    <span>PO Box 667, Steelpoort, 1133</span>
                                </div>
                            </div>
                        </div>
                    </div>
