                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <div className="topbar-adress">
                                <ul>
                                    <li className="line"><Link href="#" onClick={handleSmoothScroll}>Address : Office No 3.7, Block 7, Steelpoort, 1133</Link></li>
                                    <li><a href="mailto:info@example.com" onClick={handleSmoothScroll}>malapanemaven@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
